...
const styles = StyleSheet.create({
  ...
  backBtn: { color: '#16a34a', fontSize: 16, marginBottom: 8 },
  ...
  avatar: { width: 48, height: 48, borderRadius: 24, backgroundColor: '#16a34a', alignItems: 'center', justifyContent: 'center', marginRight: 14 },
  avatarText: { color: '#fff', fontSize: 20, fontWeight: '800' },
  avatarSmall: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#16a34a', alignItems: 'center', justifyContent: 'center' },
  ...
  bubbleBenim: { alignSelf: 'flex-end', backgroundColor: '#16a34a', borderBottomRightRadius: 4 },
